...
FORBIDDEN_ROOTS = {"data", "models", "logs", "tmp", "archive", "literature"}
REQUIRED = {
    "CITATION.cff",
    "LICENSE",
    "README.md",
    ...
    "docs/MODEL_CARD.md",
    "output/pdf/auxiliary_cues_novel_verb_acl_draft.pdf",
    "paper/main.tex",
...
def main() -> None:
    ...
    print(
        ...
        f"{len(REQUIRED)} required files, headline aggregates reproduced, "
        f"{checksum_count} checksums verified"
    )
